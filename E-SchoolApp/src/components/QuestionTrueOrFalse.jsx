...
const QuestionTrueOrFalse = ({ finalQuestionSet, subjectName, handleSetImageSetQuestion, handleSetFinalQuestionSet, handleNotificationFromChild}) => {
