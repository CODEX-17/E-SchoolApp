  ...
  return (
    <div className={style.container}>
        ...
        <div className={style.card}>
            ...
            <div 
                className={style.postBotton} 
                onClick={() => setIsShowModal(true)}
            >Share your thoughts here...</div>
                            ...
                            <div className='d-flex w-50 justify-content-end'>
                                {
                                    ...
                                    <AiOutlineDelete id={style.deleteBtn} title='delete' onClick={() => handleDeletePost(post.postID, post.imageID, post.fileID)}/>
                                }
                            </div>
                        </div>
