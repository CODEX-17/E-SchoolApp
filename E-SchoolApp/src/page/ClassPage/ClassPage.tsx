      ...
      const fetchData = async () => {
        ...
        if (response) {
          setTimeout(() => {
            ...
            response.forEach((classes: Class) =>
              socket.emit("joinRoom", classes.classCode)
            );
      ...
      {showPreview === "classPage" && (
        <div className={style.container}>
          <div className={style.header}>
            ...
            {userDetails && userDetails.acctype === "Faculty" && (
              <button onClick={handleCreateClass}>{textButton}</button>
            )}
          </div>

          <div className={style.content}>
            {showCreateClass && <AddClass />}
                            ...
                            <div className={style.classCard} key={index}>
                              <div style={{ width: "100%", height: "20%" }}>
                                <AiFillEyeInvisible
                                  ...
                                  title="Hide class"
                                  onClick={() =>
                                    handleClassVisibility(data.id, true)
                                  }
                                />
                              </div>
                              <div
                            ...
                            <div className={style.classCard} key={index}>
                              <div style={{ width: "100%", height: "20%" }}>
                                <AiFillEyeInvisible
                                  ...
                                  title="Hide class"
                                  onClick={() =>
                                    handleClassVisibility(data.id, false)
                                  }
                                />
                              </div>
                              <div
